...
public class AboutWindow extends JDialog implements MouseListener {
    ...
    public AboutWindow() {
        ...
        labelLogo = new JLabel(new ImageIcon(getClass().getResource("/com/TicTacToc/images/logo.png")));
        ...
        for (int i = 0; i < NUMBER_OF_IMAGES; i++) {
        	labelImg[i] = new JLabel(new ImageIcon(getClass().getResource("/com/TicTacToc/images/" + IMAGE_NAME[i]  + ".png")));
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (e.getSource().equals(labelImg[i]))
            try {
                Desktop.getDesktop().browse(new URI("https://www." + IMAGE_NAME[i] + ".com"));
        } catch (Exception ex) {
